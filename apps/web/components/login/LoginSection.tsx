...
export default function LoginSection() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    router.push(selectedRole === 'User' ? '/student/dashboard' : '/librarian/dashboard');
  };

  const isGuest = selectedRole === 'guest';

  return (
    /* Full screen — LRC banner as background */
    <div
      ...
      <div className="relative z-10 flex w-full max-w-md flex-col items-center gap-5">
        ...
        <div className="flex flex-col items-center gap-2 text-white">
          ...
          <div className="flex flex-col items-center">
            <span className="text-lg font-bold tracking-tight">Lasallia</span>
        ...
        {/* ── Sign in card ── */}
        <div className="w-full overflow-y-auto rounded-2xl border border-white/20 bg-white/95 p-5 shadow-2xl backdrop-blur-md sm:p-6">
            ...
            <div className="grid grid-cols-3 gap-2">
              ...
              >
                <div className="space-y-1">
                  <div className={`flex h-7 w-7 items-center justify-center rounded-md sm:h-8 sm:w-8 transition-colors ${
                  ...
                  <div>
                    <h3 className="text-xs font-semibold text-gray-900 sm:text-sm">Guest</h3>
                    <p className="text-[10px] text-gray-500 sm:text-xs">Browse catalog</p>
                  </div>
                </div>
                {selectedRole === 'guest' && (
                  <div className="absolute right-1.5 top-1.5 flex h-4 w-4 items-center justify-center rounded-full bg-gray-600">
              ...
              >
                <div className="space-y-1">
                  <div className={`flex h-7 w-7 items-center justify-center rounded-md sm:h-8 sm:w-8 transition-colors ${
                    selectedRole === 'User' ? 'bg-emerald-600' : 'bg-gray-100 group-hover:bg-gray-200'
                  }`}>
                    <svg className={`h-4 w-4 ${selectedRole === 'User' ? 'text-white' : 'text-gray-600'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                    </svg>
                  </div>
                  <div>
                    <h3 className={`text-xs font-semibold sm:text-sm ${selectedRole === 'User' ? 'text-emerald-900' : 'text-gray-900'}`}>
                      User
                    </h3>
                ...
                {selectedRole === 'User' && (
                  <div className="absolute right-1.5 top-1.5 flex h-4 w-4 items-center justify-center rounded-full bg-emerald-600">
                    <svg className="h-2.5 w-2.5 text-white" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                  </div>
              ...
              >
                <div className="space-y-1">
                  ...
                  <div>
                    <h3 className={`text-xs font-semibold sm:text-sm ${selectedRole === 'librarian' ? 'text-amber-900' : 'text-gray-900'}`}>
                      Librarian
                    </h3>
          ...
          {/* Guest notice */}
          {isGuest && (
            <div className="mb-4 rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-xs text-gray-600 sm:text-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
                ...
                <div>
                  ...
                  <div className="relative mt-1">
                    ...
                    <input
                      ...
                      } py-2 pl-9 pr-3 text-sm text-gray-900 placeholder-gray-400 focus:border-emerald-600 focus:outline-none focus:ring-2 focus:ring-emerald-600/20 transition-all`}
                      required
                    />
                  </div>
                  {errors.email && (
                ...
                <div>
                  ...
                  <div className="relative mt-1">
                    ...
                    <input
                      ...
                      } py-2 pl-9 pr-11 text-sm text-gray-900 placeholder-gray-400 focus:border-emerald-600 focus:outline-none focus:ring-2 focus:ring-emerald-600/20 transition-all`}
                      required
                      minLength={6}
                    />
                    <button
            ...
            >
              {isGuest
                ? 'Continue as Guest'
                : `Sign In as ${selectedRole === 'User' ? 'Student / Faculty' : 'Librarian'}`}
            </button>
          </form>
